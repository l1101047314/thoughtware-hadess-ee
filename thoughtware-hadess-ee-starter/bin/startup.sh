...
APP_MAIN="io.thoughtware.hadess.starter.HadessEeApplication"
...
JAVA_OPTS="$JAVA_OPTS -server -Xms2048m -Xmx2048m -Xmn512m -XX:ParallelGCThreads=20 -XX:+UseParallelGC -XX:MaxGCPauseMillis=850 -Xloggc:$APP_LOG/gc.log -Dfile.encoding=UTF-8"
